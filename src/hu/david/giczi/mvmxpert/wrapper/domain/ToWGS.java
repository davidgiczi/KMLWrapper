...
public class ToWGS {
    ...
    private void createMatrixA(){
        ...
        MATRIX_A[0][1] = 0.0;
        MATRIX_A[0][2] = 0.0;
        MATRIX_A[0][3] = COMMON_POINTS.get(0).getX_IUGG67();
        MATRIX_A[0][4] = 0.0;
        MATRIX_A[0][5] = - 1 * COMMON_POINTS.get(0).getZ_IUGG67();
        MATRIX_A[0][6] = COMMON_POINTS.get(0).getY_IUGG67();

        MATRIX_A[1][0] = 0.0;
        MATRIX_A[1][1] = 1.0;
        MATRIX_A[1][2] = 0.0;
        MATRIX_A[1][3] = COMMON_POINTS.get(0).getY_IUGG67();
        MATRIX_A[1][4] = COMMON_POINTS.get(0).getZ_IUGG67();
        MATRIX_A[1][5] = 0.0;
        MATRIX_A[1][6] = - 1 * COMMON_POINTS.get(0).getX_IUGG67();

        MATRIX_A[2][0] = 0.0;
        MATRIX_A[2][1] = 0.0;
        MATRIX_A[2][2] = 1.0;
        MATRIX_A[2][3] = COMMON_POINTS.get(0).getZ_IUGG67();
        MATRIX_A[2][4] = - 1 * COMMON_POINTS.get(0).getY_IUGG67();
        MATRIX_A[2][5] = COMMON_POINTS.get(0).getX_IUGG67();
        MATRIX_A[2][6] = 0.0;

        MATRIX_A[3][0] = 1.0;
        MATRIX_A[3][1] = 0.0;
        MATRIX_A[3][2] = 0.0;
        MATRIX_A[3][3] = COMMON_POINTS.get(1).getX_IUGG67();
        MATRIX_A[3][4] = 0.0;
        MATRIX_A[3][5] = - 1 * COMMON_POINTS.get(1).getZ_IUGG67();
        MATRIX_A[3][6] = COMMON_POINTS.get(1).getY_IUGG67();

        MATRIX_A[4][0] = 0.0;
        MATRIX_A[4][1] = 1.0;
        MATRIX_A[4][2] = 0.0;
        MATRIX_A[4][3] = COMMON_POINTS.get(1).getY_IUGG67();
        MATRIX_A[4][4] = COMMON_POINTS.get(1).getZ_IUGG67();
        MATRIX_A[4][5] = 0.0;
        MATRIX_A[4][6] = - 1 * COMMON_POINTS.get(1).getX_IUGG67();

        MATRIX_A[5][0] = 0.0;
        MATRIX_A[5][1] = 0.0;
        MATRIX_A[5][2] = 1.0;
        MATRIX_A[5][3] = COMMON_POINTS.get(1).getZ_IUGG67();
        MATRIX_A[5][4] = - 1 * COMMON_POINTS.get(1).getY_IUGG67();
        MATRIX_A[5][5] = COMMON_POINTS.get(1).getX_IUGG67();
        MATRIX_A[5][6] = 0.0;

        MATRIX_A[6][0] = 1.0;
        MATRIX_A[6][1] = 0.0;
        MATRIX_A[6][2] = 0.0;
        MATRIX_A[6][3] = COMMON_POINTS.get(2).getX_IUGG67();
        MATRIX_A[6][4] = 0.0;
        MATRIX_A[6][5] = - 1 * COMMON_POINTS.get(2).getZ_IUGG67();
        MATRIX_A[6][6] = COMMON_POINTS.get(2).getY_IUGG67();

        MATRIX_A[7][0] = 0.0;
        MATRIX_A[7][1] = 1.0;
        MATRIX_A[7][2] = 0.0;
        MATRIX_A[7][3] = COMMON_POINTS.get(2).getY_IUGG67();
        MATRIX_A[7][4] = COMMON_POINTS.get(2).getZ_IUGG67();
        MATRIX_A[7][5] = 0.0;
        MATRIX_A[7][6] = - 1 * COMMON_POINTS.get(2).getX_IUGG67();

        MATRIX_A[8][0] = 0.0;
        MATRIX_A[8][1] = 0.0;
        MATRIX_A[8][2] = 1.0;
        MATRIX_A[8][3] = COMMON_POINTS.get(2).getZ_IUGG67();
        MATRIX_A[8][4] = - 1 * COMMON_POINTS.get(2).getY_IUGG67();
        MATRIX_A[8][5] = COMMON_POINTS.get(2).getX_IUGG67();
        MATRIX_A[8][6] = 0.0;

        MATRIX_A[9][0] = 1.0;
        MATRIX_A[9][1] = 0.0;
        MATRIX_A[9][2] = 0.0;
        MATRIX_A[9][3] = COMMON_POINTS.get(3).getX_IUGG67();
        MATRIX_A[9][4] = 0.0;
        MATRIX_A[9][5] = - 1 * COMMON_POINTS.get(3).getZ_IUGG67();
        MATRIX_A[9][6] = COMMON_POINTS.get(3).getY_IUGG67();

        MATRIX_A[10][0] = 0.0;
        MATRIX_A[10][1] = 1.0;
        MATRIX_A[10][2] = 0.0;
        MATRIX_A[10][3] = COMMON_POINTS.get(3).getY_IUGG67();
        MATRIX_A[10][4] = COMMON_POINTS.get(3).getZ_IUGG67();
        MATRIX_A[10][5] = 0.0;
        MATRIX_A[10][6] = - 1 * COMMON_POINTS.get(3).getX_IUGG67();

        MATRIX_A[11][0] = 0.0;
        MATRIX_A[11][1] = 0.0;
        MATRIX_A[11][2] = 1.0;
        MATRIX_A[11][3] = COMMON_POINTS.get(3).getZ_IUGG67();
        MATRIX_A[11][4] = - 1 * COMMON_POINTS.get(3).getY_IUGG67();
        MATRIX_A[11][5] = COMMON_POINTS.get(3).getX_IUGG67();
        MATRIX_A[11][6] = 0.0;

        MATRIX_A[12][0] = 1.0;
        MATRIX_A[12][1] = 0.0;
        MATRIX_A[12][2] = 0.0;
        MATRIX_A[12][3] = COMMON_POINTS.get(4).getX_IUGG67();
        MATRIX_A[12][4] = 0.0;
        MATRIX_A[12][5] = - 1 * COMMON_POINTS.get(4).getZ_IUGG67();
        MATRIX_A[12][6] = COMMON_POINTS.get(4).getY_IUGG67();

        MATRIX_A[13][0] = 0.0;
        MATRIX_A[13][1] = 1.0;
        MATRIX_A[13][2] = 0.0;
        MATRIX_A[13][3] = COMMON_POINTS.get(4).getY_IUGG67();
        MATRIX_A[13][4] = COMMON_POINTS.get(4).getZ_IUGG67();
        MATRIX_A[13][5] = 0.0;
        MATRIX_A[13][6] = - 1 * COMMON_POINTS.get(4).getX_IUGG67();

        MATRIX_A[14][0] = 0.0;
        MATRIX_A[14][1] = 0.0;
        MATRIX_A[14][2] = 1.0;
        MATRIX_A[14][3] = COMMON_POINTS.get(4).getZ_IUGG67();
    ...
    private void createMatrix_l(){
        MATRIX_l[0][0] = COMMON_POINTS.get(0).getX_WGS84();
        MATRIX_l[1][0] = COMMON_POINTS.get(0).getY_WGS84();
        MATRIX_l[2][0] = COMMON_POINTS.get(0).getZ_WGS84();
        MATRIX_l[3][0] = COMMON_POINTS.get(1).getX_WGS84();
        MATRIX_l[4][0] = COMMON_POINTS.get(1).getY_WGS84();
        MATRIX_l[5][0] = COMMON_POINTS.get(1).getZ_WGS84();
        MATRIX_l[6][0] = COMMON_POINTS.get(2).getX_WGS84();
        MATRIX_l[7][0] = COMMON_POINTS.get(2).getY_WGS84();
        MATRIX_l[8][0] = COMMON_POINTS.get(2).getZ_WGS84();
        MATRIX_l[9][0] = COMMON_POINTS.get(3).getX_WGS84();
        MATRIX_l[10][0] = COMMON_POINTS.get(3).getY_WGS84();
        MATRIX_l[11][0] = COMMON_POINTS.get(3).getZ_WGS84();
